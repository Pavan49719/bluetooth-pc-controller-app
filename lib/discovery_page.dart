...
import 'package:pccontroller/bluetooth_device_list_entry.dart';
                ...
                try {
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: Text(bonded ? 'Pairing' : 'Unpairing'),
                        content: Text(
                            '${bonded ? 'Pairing' : 'Unpairing'} with ${result.device.name} has succeded.'),
                        actions: <Widget>[
                          new FlatButton(
